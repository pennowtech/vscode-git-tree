...
function testFeatureSurface() {
  ...
  const sourceChecks = [
    ...
    ['src/views.js', /changeGroup\('Unstaged Changes', 'working'/, 'Unstaged changes group'],
    ['src/views.js', /gitDecoration\.stageModifiedResourceForeground/, 'Staged group color'],
    ['src/views.js', /gitDecoration\.modifiedResourceForeground/, 'Unstaged group color'],
    ['src/extension.js', /getExtension\('vscode\.git'\)/, 'VS Code Git executable discovery'],
